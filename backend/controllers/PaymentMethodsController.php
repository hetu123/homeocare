...
class PaymentMethodsController extends Controller
{
    ...
    {
        $id= $_POST['id'];
        $category = PaymentMethods::findOne(['id'=>$id]);
        if($category->is_active==1)
        {
            ...
            {
                Yii::$app->session->setFlash('success', 'successfully Inactive paymet method');
            }
        }
        else
        {
            ...
            if($category->save(false))
            {
                Yii::$app->session->setFlash('success', 'successfully active paymet method');
            }
        }
    }
}
