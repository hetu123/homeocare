            ...
            [
                ...
                'contentOptions' =>function ($model, $key, $index, $column)
                {
                    if($model->is_active=='1'){
                        return ['style' =>'width:100px','class'=>'btn btn-success','onclick'=>"activeBrand($model->id)"];

                    }
                    else
                    {
                        return ['style' =>'width:100px','class'=>'btn btn-danger','onclick'=>"activeBrand($model->id)"];
                    }
...
<script>
    function activeBrand($id){
        ...
        if(result) {
            $.ajax({
                url: '<?php echo Yii::$app->request->baseUrl . '/brand/active' ?>',
                type: 'post',
                data: {id: $id},
