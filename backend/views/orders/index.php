        ...
        'columns' => [
         ...
         //   'payment_method_id',
            ['attribute' => 'payment_method_id',
                ...
                'filter' => Html::activeDropDownList($searchModel, 'payment_method_id', \yii\helpers\ArrayHelper::map(\common\models\PaymentMethods::find()->orderBy('name')->asArray()->all(), 'id', 'name'),['class'=>'form-control','prompt' => 'Select Category']),
            ],
            'name',
            'email:email',
            'is_order',
